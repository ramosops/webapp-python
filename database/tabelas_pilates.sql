...
DROP TABLE IF EXISTS WEBUSER.TB_AGENDAMENTOS;
DROP TABLE IF EXISTS WEBUSER.TB_ATIVIDADES;
DROP TABLE IF EXISTS WEBUSER.TB_MEMBROS;
DROP TABLE IF EXISTS WEBUSER.TB_PLANOS;
DROP TABLE IF EXISTS WEBUSER.TB_INSTRUTORES;
