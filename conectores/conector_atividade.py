...
def new(atividade):
    ...
    values = [atividade.nome, atividade.instrutor.id, atividade.data, atividade.duracao, atividade.capacidade, atividade.tipo_plano.id, atividade.ativo]
...
def edit(atividade):
    ...
    values = [atividade.nome, atividade.instrutor.id, atividade.data, atividade.duracao, atividade.capacidade, atividade.tipo_plano.id, atividade.ativo, atividade.id]
